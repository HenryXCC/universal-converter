...
_STRINGS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "vid_multi_info":     "{n} videos seleccionados — la información solo está disponible para un archivo.",
        "vid_multi_loading":  "{n} videos · cargando información…",
        "vid_multi_header":   "{n} videos · {mb} MB en total",
        "vid_multi_more":     "+ {n} más sin información detallada",
        "vid_probe_failed":   "error al leer",
    ...
    "en": {
        ...
        "vid_clear_btn":      "✕ Clear list",
        "vid_no_file":        "No file selected",
        "vid_info_section":   "▸ INFORMATION",
        "vid_info_hint":      "Select a video to see its information.",
        "vid_multi_info":     "{n} videos selected — info is only available for a single file.",
        "vid_multi_loading":  "{n} videos · loading info…",
        "vid_multi_header":   "{n} videos · {mb} MB total",
        "vid_multi_more":     "+ {n} more without detailed info",
        "vid_probe_failed":   "could not read file",
        "vid_gif_fps_label":  "GIF FPS:",
